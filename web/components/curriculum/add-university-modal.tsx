    ...
    try {
      ...
      if (errorMessage.includes("Not Found") || errorMessage.includes("404")) {
        toast({
          ...
          description: "Cannot save curriculum. Please ensure the backend server is running at " + (process.env.NEXT_PUBLIC_API_URL || "https://sme-panel-staging-production-2188.up.railway.app"),
          variant: "destructive",
        })
      } else {
        toast({
